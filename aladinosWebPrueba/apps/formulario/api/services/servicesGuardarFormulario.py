...
SPREADSHEET_NAME_CAPTADORES ="captadores"

SPREAD_CLIENT_CAPTADORES = initialize_gspread()
spreadsheet_list_CAPTADORES = SPREAD_CLIENT_CAPTADORES.openall()
print([spread.title for spread in spreadsheet_list_CAPTADORES])
SPREADSHEET_CAPTADORES = SPREAD_CLIENT_CAPTADORES.open(SPREADSHEET_NAME_CAPTADORES)
...
def agregar_a_google_sheetsBotonGuardarBorrador(data):
    ...
    try:
        hoja = SPREADSHEET_CAPTADORES.worksheet(mes_actual)
    except gspread.exceptions.WorksheetNotFound:
        hoja = SPREADSHEET_CAPTADORES.add_worksheet(title=mes_actual, rows="1000", cols="1000")
        # Agregar encabezado
        encabezado = [
